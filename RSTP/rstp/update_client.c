...
void udp_client() {
    ...
    while (1) {
	    ...
	    devices name is im board A 
            send the sender_ip  UDP_PORT_Tx addres do port status first time after when ever port status change that time send the port status 
